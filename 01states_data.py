#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Created on Mon Apr  1 12:45:09 2019
@author: mechrnd """

import pandas as pd
population = pd.read_csv('/home/mechrnd/MV_Feature_inspection/Software/gt/Books/data/state-population.csv')
area = pd.read_csv('/home/mechrnd/MV_Feature_inspection/Software/gt/Books/data/state-areas.csv')
abbreviation = pd.read_csv('/home/mechrnd/MV_Feature_inspection/Software/gt/Books/data/state-abbrevs.csv')
